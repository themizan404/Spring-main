...
<html>
    ...
    <body>
        <nav class="navbar navbar-light navbar-expand-md shadow-lg">
            <div class="container"><a class="navbar-brand" href="#"><img src="assets/img/loader.gif" style="width: 60px;"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav text-primary ml-auto">
                        <li class="nav-item text-primary border rounded" role="presentation" data-bs-hover-animate="pulse" style="color: rgb(0,0,0);background-color: #32a852;margin-right: 5px;"><a class="nav-link active text-uppercase" href="/employee/create" style="color: rgb(255,255,255);font-size: 20px;"><strong>Login</strong></a></li>
        ...
        <div class="container" style="margin-top: 20px;height: 62px;">
        ...
        <div class="container" style="margin-top: 20px;height: 575px;">
            <div class="row">
                <div class="col" style="width: 600px;"><img src="assets/img/hospital.png" style="width: 580px;"></div>
                <div class="col">
                    <p class="text-justify" style="margin-top: 33px;font-size: 16px;">A hospital management information system (HMIS) is an element of<br>health informatics that focuses mainly on the administration needs of<br>hospitals. In many implementations, this is a comprehensive, integrated<br>information system
